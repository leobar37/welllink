...
## Overview
Based on PRD section 2.2 and visitor flow 6.2, this module renders the advisor-facing public card at `wellnesslink.com/{username}` with actionable links and share tools.
