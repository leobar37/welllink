...
export function QrModal({ isOpen, onClose, username, displayName }: QrModalProps) {
    ...
    const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(
        `https://wellnesslink.com/${username}`
    )}`;
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle className="text-center">Escanea para conectar</DialogTitle>
