...
export function RequestCard({
  ...
  const appointmentDate = new Date(request.preferredAtUtc);
  ...
  return (
    <Card>
        ...
        <div className="flex justify-between items-start gap-4">
          <div className="flex-1 space-y-3">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Badge
                variant={getUrgencyColor(request.urgencyLevel || "normal")}
              >
            ...
            <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
              ...
              {request.patientAge && <span>{request.patientAge} años</span>}
            </div>
          </div>
      ...
      <CardFooter className="justify-between border-t pt-4 gap-3">
        ...
        <div className="flex gap-2">
          ...
          {onApprove && (
            <Button
              ...
              className={cn("min-w-[100px]", isExpiringSoon && "animate-pulse")}
            >
              Aprobar
            </Button>
          )}
