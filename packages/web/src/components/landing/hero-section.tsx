            ...
            <div className="container mx-auto px-4">
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-6">
                        ...
                        {/* Subtitle */}
                        <p className="max-w-lg text-lg text-muted-foreground animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
                        ...
                        <p className="text-sm text-muted-foreground animate-in fade-in duration-700 delay-500">
                            <span className="font-semibold text-foreground">100+</span> asesores
                            ya usan Welllink
                        </p>
                    </div>
