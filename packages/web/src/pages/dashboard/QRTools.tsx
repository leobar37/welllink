        ...
        <TabsContent value="qr" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Escanea para visitar tu perfil al instante.
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="card">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Descarga y comparte esta imagen en redes sociales o imprímela.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center space-y-6">
              {/* Card Preview Area */}
                ...
                <div className="flex items-start gap-4 z-10">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90">
                      {profile.title || "Asesor de Bienestar"}
                    </p>
                  </div>
                </div>
